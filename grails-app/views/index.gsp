    ...
    <section id="main" class="span9">
        ...
        <div class="row-fluid">
            ...
            <div class="span4">
                ...
                <pre>runtime ':twitter-bootstrap:${applicationContext.getBean('pluginManager').getGrailsPlugin('twitter-bootstrap')}'
                runtime ':fields:${applicationContext.getBean('pluginManager').getGrailsPlugin('fields')}'</pre>
